    ...
    private class MyHighlighter extends SyntaxHighlighterBase {
        ...
        public Lexer getHighlightingLexer() {
            ...
            layeredLexer.registerSelfStoppingLayer(
                    new StringLiteralLexer('\"', JsonElementTypes.DOUBLE_QUOTED_STRING, isCanEscapeEol(),
            ...
            layeredLexer.registerSelfStoppingLayer(
                    new StringLiteralLexer('\'', JsonElementTypes.SINGLE_QUOTED_STRING, isCanEscapeEol(),
                            isPermissiveDialect ? PERMISSIVE_ESCAPES : "/", false, isPermissiveDialect) {
                        @NotNull
                        @Override
                        protected IElementType handleSingleSlashEscapeSequence() {
